    ...
    return (
        <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6 ">
            <div className="mx-auto max-w-screen-sm text-center">
                  ...
                  <p className="mb-4 text-3xl tracking-tight font-bold text-slate-400">Pokemon not Found</p>
                  <p className="mb-4 text-lg font-light text-slate-400">Back to the homepage and try to refresh the page. </p>
